...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [20] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(62),
  [23] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(73),
  ...
  [40] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(48),
  [43] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(54),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(30),
  [49] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(70),
  ...
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_statement_repeat1, 2), SHIFT_REPEAT(52),
  [71] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_statement_repeat1, 2), SHIFT_REPEAT(53),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_statement_repeat1, 2), SHIFT_REPEAT(31),
  ...
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 3),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 3),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 3),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 4),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 4),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_expression, 1),
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 4),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 4),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 3),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 3),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_statement, 3),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_file_statement, 3),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_statement, 3),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_statement, 3),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_statement, 2),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_file_statement, 2),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_statement, 2),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_use_statement, 2),
  ...
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition_type, 1),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__conditional, 3),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__conditional, 3),
